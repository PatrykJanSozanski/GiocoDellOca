...
/**
 * The class which represents the DoubleRollCell object.
 */
public class DoubleRollCell implements Cell {
    /**
    ...
    /**
     * Constructor of the double-roll cell.
     *
     * @param cellIndex the index of the cell
     * @param cellDescription the description of the cell
     */
    public DoubleRollCell(int cellIndex, String cellDescription) {
     ...
     * For double-roll cells the returned value is dependent from the result of the diceRoll method
     * and is equal to the index of the cell plus the result of the dice roll.
     *
     ...
     * For double-roll cells the returned value is dependent from the result of the diceRoll.
     *
     * @param player the player arriving to the cell
     * @param diceRoll the result of the dice roll when the player reaches this cell
     * @return the animation string for the output file
    ...
    public String getSecondaryAnimation(Player player, int diceRoll) {
        ...
        animationOutput += "\n";
        animationOutput += "SPOSTA";
        for (int i = this.getIndex() + 1; i <= this.getFinalIndex(diceRoll); i++){
            animationOutput += " ";
            animationOutput += i;
        }
        animationOutput += "\n";
     ...
     */
    private int getFinalIndex(int diceRoll) {
        return this.getIndex() + diceRoll;
    }
}