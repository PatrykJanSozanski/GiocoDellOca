...
/**
 * The class which represents the GoBackCell object.
 */
public class GoBackCell implements Cell {
    /**
    ...
    /**
     * The number that indicates to the arriving player for how many cells he has to move back.
     */
    private int numberOfCellsBack;
    ...
    /**
     * Constructor of the go-back cell.
     *
     * @param cellIndex the index of the cell
     * @param cellsBack the number of cells to go back from this cell
     * @param cellDescription the description of the cell
     */
    public GoBackCell(int cellIndex, int cellsBack, String cellDescription) {
        this.index = cellIndex;
        this.numberOfCellsBack = cellsBack;
     ...
     * For go-back cells the returned value is not dependent from the result of the diceRoll method
     * and is equal to the index of the cell minus the number of cells that the player has to go back.
     *
     ...
     * For go-back cells the returned value is not dependent from the result of the diceRoll.
     *
     * @param player the player arriving to the cell
     * @param diceRoll the result of the dice roll when the player reaches this cell
     * @return the animation string for the output file
    ...
    private int getFinalIndex() {
        return this.index - this.numberOfCellsBack;
    }
}